      ...
      >
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-green-50/50 to-emerald-50/50 dark:from-green-900/10 dark:to-emerald-900/10 rounded-xl border border-green-100/50 dark:border-green-800/50'>
          ...
          <div className='space-y-1.5'>
            ...
            >
              ...
              <option value='Alcohol' className='text-gray-900 dark:text-gray-100'>
                🍺 Alcohol
              </option>
              <option value='Cigarettes' className='text-gray-900 dark:text-gray-100'>
                🚬 Cigarettes
              </option>
        ...
        <div className='mb-4'>
          ...
          <select
            ...
            className='w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500 transition-all duration-200'
          >
        ...
        <div className='mb-4 flex items-center gap-2'>
          <input
            ...
            className='w-4 h-4 rounded border-gray-300 dark:border-gray-600 focus:ring-emerald-500'
          />
          <label htmlFor='isRecurring' className='text-xs font-semibold text-gray-700 dark:text-gray-300'>Recurring Expense</label>
        </div>

        {/* Submit Button */}
        <button
          type='submit'
          className='w-full relative overflow-hidden bg-gradient-to-r from-emerald-600 via-green-500 to-teal-500 hover:from-emerald-700 hover:via-green-600 hover:to-teal-600 text-white px-4 py-2 sm:px-5 sm:py-2 rounded-xl font-semibold shadow-xl hover:shadow-2xl group transition-all duration-300 border-2 border-transparent hover:border-white/20 text-sm sm:text-base'
          disabled={isLoading}
        >
