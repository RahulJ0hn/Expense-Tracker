...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      className='sticky top-0 z-50 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-600/50 shadow-lg shadow-gray-900/5 dark:shadow-black/30'
    >
        ...
        <div className='flex items-center justify-between h-14 sm:h-16'>
          ...
          <div className='flex items-center space-x-1 sm:space-x-2'>
            ...
            <div className='sm:hidden'>
              <SignedOut>
                <SignInButton>
                  <button className='relative overflow-hidden bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 hover:from-emerald-600 hover:via-green-600 hover:to-teal-600 text-white px-3 py-2 rounded-lg text-xs font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 active:scale-95'>
              ...
              <SignedIn>
                <UserButton
                  appearance={{
                    elements: {
                      avatarBox: 'w-12 h-12 rounded-full hover:scale-110 transition-transform duration-200',
                      userButtonBox: 'flex items-center justify-center',
                    },
                  }}
                />
