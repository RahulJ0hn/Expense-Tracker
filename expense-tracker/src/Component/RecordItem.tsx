...
const RecordItem = ({ record }: { record: Record }) => {
  ...
  return (
    <li
      className={`bg-white dark:bg-gray-700 text-black dark:text-gray-100 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100/50 dark:border-gray-600/50 border-l-4 ${getBorderColor(
        record?.amount
